 ...
 * Companies: -
 * Hint: There is a restaurant with a single chef. You are given an array customers, where customers[i] = [arrivali, timei]:
...
public class AverageWaitingTimeCalculator {
    public static double averageWaitingTime(int[][] customers) {
        int currentTime = 0;
        long totalWaitingTime = 0; // Using long to prevent overflow

        for (int[] customer : customers) {
            int arrivalTime = customer[0];
            int serviceTime = customer[1];
            
            // Determine when the chef can start preparing this customer's order
        ...
        double avgWaitingTime = (double) totalWaitingTime / customers.length;
    ...
    public static void main(String[] args) {
        ...
        double avg1 = averageWaitingTime(customers1);
        System.out.println("Average waiting time for example 1: " + avg1);

        // Example 2
        int[][] customers2 = {{5, 2}, {5, 4}, {10, 3}, {20, 1}};
        double avg2 = averageWaitingTime(customers2);
        System.out.println("Average waiting time for example 2: " + avg2);
    }
}
